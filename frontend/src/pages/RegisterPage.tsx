    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-2">Yangi hisob yarating — bepul</p>
        </div>
        ...
        <div className="bg-white/4 border border-white/10 rounded-2xl p-8">
          ...
          <form onSubmit={submit} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-gray-400 mb-1.5">To'liq ism</label>
              <input
                type="text"
                value={fullName}
          ...
          <p className="text-center text-xs text-gray-600 mt-4">
            ...
            <span className="text-gray-500">foydalanish shartlarimizga</span> rozilik bildirasiz.
          </p>
        </div>
